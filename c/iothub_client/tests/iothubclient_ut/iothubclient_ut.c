...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    REGISTER_GLOBAL_MOCK_RETURN(IoTHubTransport_GetLock, TEST_LOCK_HANDLE);
...
TEST_FUNCTION(IoTHubClient_SetConnectionStatusCallback_succeed)
{
    ...
    STRICT_EXPECTED_CALL(Lock(TEST_LOCK_HANDLE));
    EXPECTED_CALL(ThreadAPI_Create(IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG));
    STRICT_EXPECTED_CALL(IoTHubClient_LL_SetConnectionStatusCallback(TEST_IOTHUB_CLIENT_HANDLE, test_connection_status_callback, NULL));
    STRICT_EXPECTED_CALL(Unlock(TEST_LOCK_HANDLE));
