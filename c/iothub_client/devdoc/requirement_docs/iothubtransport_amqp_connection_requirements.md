...
```c
	typedef enum CONNECTION_ERROR_CODE_TAG
	{
		CONNECTION_ERROR,
...
**SRS_IOTHUBTRANSPORT_AMQP_CONNECTION_09_009: [**`config->on_error_callback` shall be saved on `instance->on_error_callback`**]**
**SRS_IOTHUBTRANSPORT_AMQP_CONNECTION_09_010: [**`config->on_error_context` shall be saved on `instance->on_error_context`**]**
...
**SRS_IOTHUBTRANSPORT_AMQP_CONNECTION_09_033: [**If the cbs_open() calls back with an error, `instance->on_error_callback` shall be invoked if set passing code CONNECTION_CBS_ERROR and `instance->on_error_context`**]**
...
**SRS_IOTHUBTRANSPORT_AMQP_CONNECTION_09_062: [**If `on_connection_state_changed` is called back but CBS connection has been created, it shall return immediatelly**]**
Note: In this case, `on_connection_state_changed` will defer to `on_cbs_state_changed` callback to control this module state.
...
**SRS_IOTHUBTRANSPORT_AMQP_CONNECTION_09_065: [**If `on_connection_state_changed` new state is CONNECTION_STATE_END or CONNECTION_STATE_ERROR, `instance->on_state_changed_callback` shall be invoked with state AMQP_CONNECTION_STATE_CLOSED**]**

#### on_cbs_state_changed
**SRS_IOTHUBTRANSPORT_AMQP_CONNECTION_09_063: [**If `on_cbs_state_changed` is called back, `instance->on_state_changed_callback` shall be invoked, if defined, only if the new state is different than the previous**]**
**SRS_IOTHUBTRANSPORT_AMQP_CONNECTION_09_064: [**If `on_cbs_state_changed` new state is AMQP_MANAGEMENT_STATE_OPEN, `instance->on_state_changed_callback` shall be invoked with state AMQP_CONNECTION_STATE_OPENED**]**
**SRS_IOTHUBTRANSPORT_AMQP_CONNECTION_09_065: [**If `on_cbs_state_changed` new state is AMQP_MANAGEMENT_STATE_IDLE or AMQP_MANAGEMENT_STATE_ERROR, `instance->on_state_changed_callback` shall be invoked with state AMQP_CONNECTION_STATE_CLOSED**]**

#### on_connection_error
**SRS_IOTHUBTRANSPORT_AMQP_CONNECTION_09_022: [**If the connection calls back with an I/O error, `instance->on_error_callback` shall be invoked if set passing code CONNECTION_ERROR and `instance->on_error_context`**]**
...
**SRS_IOTHUBTRANSPORT_AMQP_CONNECTION_09_052: [**If `conn_handle` is NULL, amqp_connection_set_tracing() shall fail and return __LINE__**]**
...
**SRS_IOTHUBTRANSPORT_AMQP_CONNECTION_09_056: [**amqp_connection_set_tracing() shall return success code 0**]**
